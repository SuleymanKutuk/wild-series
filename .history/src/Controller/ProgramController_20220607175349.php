...
class ProgramController extends AbstractController
{
    ...
    #[Route('/new', name: 'category_new_episode')]
    public function new(Request $request, CategoryRepository $categoryRepository, EpisodeRepository $episodeRepository): Response

    {
        $episode = new Episode();

        $form = $this->createForm(ProgramType::class, $episode);
    ...
    protected function show(int $id, ProgramRepository $programRepository, SeasonRepository $seasonRepository): Response
